...
const GlassEffect: FC<GlassEffectProps> = ({
  children,
  className = '',
  style = {},
  href,
...
// Dock Component
const GlassDock: FC<{ icons: DockIcon[], href?: string }> = ({
  icons,
  href,
}) => (
  <GlassEffect
...
// Button Component
const GlassButton: FC<{ children: ReactNode, href?: string }> = ({
  children,
  href,
}) => (
  <GlassEffect
...
export function Component() {
  ...
  return (
    <div
      className="min-h-dvh h-full flex items-center justify-center font-light relative overflow-hidden w-full"
      style={{
